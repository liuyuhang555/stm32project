# STM32F103C8T6 FreeRTOS 多任务协作系统
基于STM32F103C8T6 + FreeRTOS的多任务协作与系统可靠性设计项目，嵌入式学习/秋招实战项目。
...
2. 低功耗模式：Stop模式下USART时钟关闭导致printf重定向卡死，已定位根因，待移除阻塞式打印后重新验证。
